...
$CFG->dbtype    = 'pgsql';      // DEBE SER pgsql para PostgreSQL
...
$CFG->dboptions = array(
    'dbpersist' => false,
    'dbsocket'  => false,
    'dbport'    => loadenv('MOODLE_DB_PORT', '5432'),  // Puerto por defecto para PostgreSQL es 5432
    'dbhandlesoptions' => false,
    // Quitada la opción dbcollation que es específica de MySQL
);
...
$CFG->wwwroot   = loadenv('MOODLE_URL', 'http://localhost:8081');  // Cambiado al puerto 8081 para evitar conflictos
...
if (getenv('REDIS_HOST')) {
    ...
    $CFG->session_redis_database = loadenv('REDIS_DB', 1);  // Usar DB 1 para PostgreSQL
